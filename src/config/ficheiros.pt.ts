...
export const FICHEIROS_PT = {
  ...
  folderClient: 'Email do cliente (opcional — vazio fica só para ti)',
  share: 'Partilhar',
  shareAsk: 'Com que email queres partilhar esta pasta? Deixa vazio para a tornar privada.',
  sharedWith: 'Partilhada com {quem}',
  unshared: 'Pasta privada outra vez.',
  create: 'Criar',
  cancel: 'Cancelar',
