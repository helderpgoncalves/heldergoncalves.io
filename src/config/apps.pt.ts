// ─────────────────────────────────────────────────────────────────────
// O texto de cada aplicação, em português.
//
// Separado de copy.pt.ts pelo mesmo motivo que os.pt.ts já estava à
// parte: um ficheiro, um assunto — aqui o texto de cada janela, não o
// do sítio à volta delas. As duas línguas têm exactamente as mesmas
// chaves; ver copy.ts, que junta tudo e faz o TypeScript garanti-lo.
// ─────────────────────────────────────────────────────────────────────

export const APPS_PT = {
  apps: {
  ...
  pessoas: {
    ...
    emptySearch: 'Sem resultados para essa pesquisa.',
    email: 'Email',
  ...
  escritos: {
    ...
    comments: {
      ...
      signInFirst: 'Só quem tem sessão comenta e reage — entra para publicar.',
    },
  },
  ...
  mensagens: {
    ...
    withAssistant: 'Conversa com o assistente',
    noConversations: 'Ainda ninguém falou com o assistente.',
  ...
  definicoes: {
    ...
    admin: 'Administração',
    adminHint: 'Só tu vês isto.',
    adminMeetingsWeek: 'reuniões esta semana',
    adminMeetingsNone: 'Sem reuniões esta semana.',
    adminOpenCalendar: 'Abrir o Calendário',
    adminBlocks: 'bloqueios e aberturas activos',
  },
