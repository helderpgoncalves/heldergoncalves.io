...
export const APPS_EN = {
  ...
  mensagens: {
    ...
    replyByMail: 'Reply by email',
    ownerReading: 'You are reading. The assistant answered here, on your behalf.',
    ownerCannot: 'This house is yours — you do not talk to yourself. Pick a conversation.',
    chat: [
      {
