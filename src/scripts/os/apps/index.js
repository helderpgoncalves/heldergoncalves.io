...
const APPS = [initEscritos, initComentarios, initEscritosEditor, initSubscribe, initTerminal, initChat, initInbox, initCompose, initSettings, initSimulator, initBolsa, initCalendario, initPessoas];
