...
#
# Cem visitantes a olhar para o mesmo título são um pedido ao Yahoo,
# não cem. E quando o Yahoo falha, uma resposta velha vale mais do que
...
# Acima disto deita-se fora o mais antigo: a memória é finita e a máquina
# é partilhada.
MAX_ENTRIES = 2000
